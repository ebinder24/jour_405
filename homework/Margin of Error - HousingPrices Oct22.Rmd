...
I would say that the 'Majority Supports New City Policy' headline is not statistically justified. This is because the margin of error for all these polls suggests that it's at least a statisical possibility that a majority of people don't support the policy, especially when it comes to the first poll where the margin of error of 10 suggests that on the lower end 42% instead of 52% may support the policy. 
My headline would be that 'New City Policy Has High Levels of Support'
...
Initial results show that there is a statistical evidence that supports local officials' claims that the new light rail line has increased property values. Data obtained from the recent home sales of 10 houses show that the average price after the new transit line;s construction is at $304,500, a nearly $20,000 increase from the previous average of $285,000 prior to the transit line's construction. 

The new regional connectivity offered by the transit line, along with a growth of new businesses and restaurants within the area due to the arrival of the line could be attracting new interest that is spurring higher prices for home buyers within the area.
