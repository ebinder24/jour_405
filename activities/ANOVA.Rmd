...
When it comes to looking at SAT scores from public, private, and community colleges private schools have an edge over all the rest with a mean score of just over 1435 and a median score of around 1427. This is while public schools have a mean score of over 1360 and a median score of around 1357, and community colleges have a mean score of just over 1068 and a median score of around 1055. When looking at standard deviation private schools also have the smallest with a standard deviation of over 86, while public schools have a standrd deviation of just over 109 and community colleges have a standard deviation of over 142. This means that at private schools there is more consistency from student to student when it comes to SAT scores than either public or community schools.
...
Based on the means, medians, and standrd deviations, as well as the ANOVA test which shows that this datapoint is signifigant at any confidence level, presented across the charts and datasets there is a signifigant difference in SAT scores across the different college types when it comes to SAT scores. When it comes to the colleges that differ from each other the most it is private-community  as well as public-community colleges which differ from each other the most according to tukey's HSD test and p-levels, public-private soars above both of the other comparions. The difference between private-community is 366.95577, while public-community is 292.55140 and public private is only -74.40438.The p-value for public-private is a much more signifigant number when adjusted. According to the high F-value of 284.3, these differences between college groups outweigh the variation of SAT scores within each type of school.

Headline: SAT scores higher at private and public schools, lagging behind at community schools

Lede: It may be unsuprising, but when it comes to the average SAT scores at universities, private schools have a clear advantage over both public and community schools. Public schools have a mean SAT score of 1435, while public schools have a mean score of 1360 and community schools have a mean score of only 1068. And when it comes to the varience or standrd deviation of these scores, private schools also have less varience and more consistentcy with the smallest standrd deviation of the bunch with public schools then community schools following private in that order once again.
