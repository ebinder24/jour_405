...
One thing that raises some methodological concerns is the grouping of racial identities together. Although there are descriptors such as Levantine, Native American, and Jewish that were available to use no data for these groups were part of the survey because their were supposedly not enough responses in each category, so i believe this could lead to data not being totally representative of these groups due to the broader display of data. I also believe that the response rate of women in the survey being 55% women 45% for men. The campus population is closer to a 50/50 split at 49% women and 51% men so this could skew how men are represented in the survey versus actual opinions.
#-------------------------------------------------------------------------------
#Survey Weighting
#-------------------------------------------------------------------------------
...
The range of weights in this dataset is 0.2298 to 3.0386 or a total range of 2.8088.
2. What does it mean when a respondent has a weight of 0.23? What about 3.04? **Write your answer here:**
If a respondent has a weight of 0.23 they have been overrepresented in this dataset, which means that their vote within the data is less than one, in this case the respondent equals 0.23 of a person's vote instead of one. If a respondent has a weight of 3.04 they have been underrepresented in this dataset, which means that their vote within the data is more than one, in this case the respondent equals 3 people's vote instead of one.
3. Why might some respondents be weighted more heavily than others? **Write your answer here:**
Some respondents may be weighed higher than other due to them have demographic traits that are less common when it comes to the rest of the dataset. For example if the survey has less men or people with only a high school education represented, the data of a man with only a high school degree will be weighted more heavily when compared to other people who have a higher rate of representation.
...
When you add weighting to the results they become more accurate as the results become more based on statistical analysis versus conflicting responses that was collected when people who say they rarely vote say they will vote before the election. This will make the reporting more accurate.
...
These differences mainly exist because within groups of people who will historically make a commitment to vote versus those why may only vote in big elections or not at all, however many of these people may say they will vote and so those who the data presumes will vote before an election such as sporadic voters may be over-represented while those who never vote could be under-represented.
