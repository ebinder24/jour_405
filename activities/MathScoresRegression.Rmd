...
Based on the above plot, it seems that the average relationship between the FARMS percentage and the math test scores is that as the FARMS percentage increases, the percentage of those who met expectations with their math test scores also slightly increases.
...
**WRITE ANSWER HERE**
Based on what I've learned so far it seems that this model is not worth using for the plot above, as according to the adjusted r-squared value of 0.0254 and the p-value of 0.1225, the FARMS value does not explain much of the outcomes of the math scores, which can be accepted as a null hypothesis by the insignifigant p-value.
...
**WRITE YOUR ANSWER HERE**
The largest differences between the predicted result and the actual math scores are Whitemarsh Elementary School with a residual value of -34.8972916, Gulph Elementary School with a residual value of -31.3432381 and Crooked Billet Elementary School with a residual value of 31.1111824.
...
**WRITE YOUR ANSWER HERE**
Based on this model's results, I would say that the statement of the school board member is not totally accurate that elementary schools with fewer students on free and reduced price meals do better on standardized math tests. In addition to my interpretation of the data from the scatterplot going against this assumption, when it comes to the bottom five schools in terms of the percentage of those students not meeting or exceeding math expectations four out of five schools had a FARMS percentage that was lower than 25 percent, meanwhile the top 5 schools three out of the five schools had a FARMS percentage that was higher than 25 percent. I think this would influence my story pitch to highlight the more in depth analysis I would provide that would contradict the school board member, using this as the basis of making this into a story that mainly revolves around digging deeper and probably providing significant evidence to disprove the school board member's claim.
