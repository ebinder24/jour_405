...
Patterns that I see are that there seems to be fewer calls within the winter days, while there seem to be more calls within the summer and fall days on average.
```{r daily-calls-plot}
...
**Write your answer here**
A lot of these unusual days are concentrated throughout the year without much of a pattern. For example there is a concentration of both days with very low z-scores and very high z-scores within both the summer and fall months, which I previously said had a higher amount of calls when compared to the winter or spring in task 3. Also spring months seem to have a high concentration of outlying days where the number of calls qualifies as a statistically significantly higher, which is also something I didn't note in task 3.
```{r plot-unusual-days}
...
**Write your answer here**
I would say that 10-04-2022 Tuesday had an amount of calls that was above the mean in the most unusually statistically significant amount out of any of the other days within the dataset.
...
**Write your answer here**
Some potential angles for reporting could be that calls to 911 tend to pick up on the weekend. I would tell my editor about the z-score data and the days of the week averages that I have. My next step would be contacting 911 operators to see if their personal experience aligned with this data. Another potential angle could be that the spring months of March-May have significantly more overdose 911 calls per month. I would tell my editor about the average 911 overdose calls by month data and the daily 911 overdose call chart with the unusual data. I think my next step would again trying to get a more real life perspective on this data from the 911 operators.
