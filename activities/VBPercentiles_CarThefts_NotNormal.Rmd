...
**Your answer**:
Two examples of data that might not be normally distributed may be income across a city such as Baltimore. A few people in a city such as Baltimore may be making a lot of money, pulling the mean upwards, however this doesn't mean that most people would be making the mean amount of money per year as a lot of people in cities are living paycheck to paycheck. Another example is medal count per athlete in the Olympics, especially for a country like the U.S. Countries such as the United States and China that dominate their respective sports and often come away with dozens of medals may be pulling the mean amount of medals for the average country to be higher than countries who cannot afford to put as much resources into their olympic program

As a reporter, when working on the stories above, a statistical tool you could use for income is to use the median amount instead of the mean. For the Olympic example you could also create some graphs that demonstrate statistics such as how much money each country is spending on their Olympic programs.
#------------------------------------------------------------------------------#
...
**Answer**:
Maryland is in the 95th percentile in terms of aces with 223, which ranks them at 17th out of 343 teams. Maryland on average is scoring more aces than 95 percent of teams and scoring less aces than 5 percent of teams. Maryland had their most aces in one game against American University at 16, this is tied with 15 other teams. Saint Francis is the team with the most aces in one game at 22 versus Morgan State.
...
**Answer**: The data is skewed to the left. 68 percent of the data is covered by one standard deviation from the mean on both sides. 
