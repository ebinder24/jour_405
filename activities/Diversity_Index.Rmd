...
Lede: According to the USA Today diversity index that calculates the probability that two people randomly chosen people within one city will not be of the same race or ethnicity, Prince George's County holds both two of the top three most diverse cities and two of the top three least diverse cities within the state.
